...
This document is a general introduction to the CDK. Readers should have basic familiarity with the [Airbyte Specification](../../understanding-airbyte/airbyte-specification.md) before proceeding.
...
Additionally, you can follow [this tutorial](../tutorials/cdk-tutorial-python-http/) for a complete walkthrough of creating an HTTP connector using the Airbyte CDK.
