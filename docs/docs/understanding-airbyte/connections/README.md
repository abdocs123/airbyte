...
* A catalog selection: which [streams and fields](../airbyte-catalog-reference.md) to replicate from the source
...
Sync schedules are explained below. For information about catalog selections, see [AirbyteCatalog & ConfiguredAirbyteCatalog](../airbyte-catalog-reference.md).
